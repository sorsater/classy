...
tests = [
    ...
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '1'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '2'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '5'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '10'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '20'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '50'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '100'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '250'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '500'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '1000'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '5000'],
    ['billboard.json', '--genres', 'pop', 'rap', '--iterations', '5', '--uni_thresh', '10000'],
]
